                    ...
                    success: function (data) {
                        if (data.MessageType == 1) {
                            Swal.fire({
                                ...
                                if (result.value) {
                                    window.location = "/ConsumerPayment/Consignment";
                                }
                            });
                        }
                        else {
            ...
            success: function (data) {
                ...
                oTable = $("#tbl").dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "mData": "sConsignmentFinalDate", "bSearchable": true, "bSortable": true, "width": "10%" },
                        ...
                        { "mData": "OverDay", "bSearchable": true, "bSortable": true, "width": "5%" },
...
function Edit(id) {
    window.location = "/ConsumerPayment/ConsignmentEdit?id=" + id;
}
