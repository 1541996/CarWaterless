...
$(document).ready(function () {
    ...
    var messagetype = document.getElementById("hdMessageType").value;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                oTable = $("#tbl").dataTable({
                    ...
                    "aoColumns": [
                        {
                            "mData": "No", "bSearchable": false, "bSortable": false, "width": "10%",
...
function Delete(id) {
    ...
    Swal.fire({
        ...
        text: "Deleting Supppliers may occur errors for existing stocks.",
        type: 'warning',
